CREATE TABLE artists (id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, name TEXT(255));
CREATE TABLE albums (id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, name TEXT(255), artist_id INTEGER REFERENCES artists);
